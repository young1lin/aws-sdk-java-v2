...
public class IdentifierParser implements Parser<String> {
    private static final Parser<String> PARSER =
        new TrimWhitespaceParser<>(new CheckBoundsParser<>(new IdentifierParser()));
    ...
    @Override
    public ParseResult<String> parse(int startPosition, int endPosition, ParserContext context) {
    }
}
